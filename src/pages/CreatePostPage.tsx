      ...
      <div className="mt-6 w-5/6 mx-auto">
        ...
        <div className="my-3">
          <label className="text-xs md:text-sm my-3 text-primary-light-2 dark:text-white">
            {" "}
            Etiquetar curso/s o catedrático/s{" "}
          </label>
          <SelectSection />
        </div>
        <hr />
        <Formik initialValues={formInitialState} onSubmit={createPost}>
          <Form>
            <div className="flex flex-col gap-y-4">
              <TextField
                placeholder="¿Recomendaciones para compiladores 1?"
                name="title"
                label="Titulo"
              />
              <TextField
                placeholder="He intentado sacar compiladores en vacaciones pero el catedrático..."
                variant="textarea"
                label="Descripción"
                name="description"
              />
